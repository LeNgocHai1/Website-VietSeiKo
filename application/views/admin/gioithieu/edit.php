              ...
              <form class="form-horizontal" action="<?php admin_url('gioi_thieu/add')?>" method="post">
                ...
                <div class="box-body">
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <input type="text" class="form-control" name="title" id="title" value="<?php echo $gioithieu_infor->title?>" placeholder=" Tiêu đề">
                   ...
                   <div class="form-group ">
                    ...
                    <div class="col-sm-10">
                      ...
                      <textarea id="editor1" class="editor1" name="contents" rows="10" ><?php echo $gioithieu_infor->contents?></textarea>                      
