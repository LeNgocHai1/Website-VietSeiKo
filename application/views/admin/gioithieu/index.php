              ...
              <div class="box-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tr>
                    ...
                    <!-- <td><?php echo get_date($row->created)?></td> -->
                    <td class="option">
                       <a href="<?php echo admin_url('gioi_thieu/edit/'.$row->id); ?>" title="Chỉnh sửa" class="tipS ">
                      <i class="fa fa-edit" style="margin-left: 20px;"></i>
                      </a>                    
                      <a href="<?php echo admin_url('gioi_thieu/delete/'.$row->id); ?>" title="Xóa" class="tipS verify_action" >
