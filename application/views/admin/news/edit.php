              ...
              <form class="form-horizontal" action="#" method="post">
                ...
                <div class="box-body">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-8">
                      <input type="text" class="form-control" name="nameNews" id="nameNews" value="<?php echo $infor->nameNews?>" placeholder=" Chức danh">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-8">
                      <input type="text" class="form-control" name="nameNews_flug" id="nameNews_flug" value="<?php echo $infor->nameNews_flug?>" placeholder="example-chuc-danh">
                      <span name="name_autocheck" class="autocheck"></span>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-8">
                      <input type="text" class="form-control" name="code" id="code" value="<?php echo $infor->code?>" placeholder="Mã công việc">
                      <span name="name_autocheck" class="autocheck"></span>
                  ...
                  <div class="form-group">
                    <label for="username" class="col-sm-3 control-label"> Chức danh</label>
                    <div class="col-sm-8">
                      <input type="text" class="form-control" name="infoCPN" id="infoCPN" value="<?php echo $infor->infoCPN?>" placeholder=" Thông tin công ty">
                      <span name="name_autocheck" class="autocheck"></span>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-8">
                      <input type="text" class="form-control" name="staffNumber" id="staffNumber" value="<?php echo $infor->staffNumber?>" placeholder=" Số nhân viên ">
                      <span name="name_autocheck" class="autocheck"></span>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-8">
                      <input type="text" class="form-control" name="jobs" id="jobs" value="<?php echo $infor->jobs?>" placeholder=" Ngành nghề">
                      <span name="name_autocheck" class="autocheck"></span>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-8">
                      <input type="text" class="form-control" name="address" id="address" value="<?php echo $infor->address?>" placeholder=" Địa điểm làm việc">
                      <span name="name_autocheck" class="autocheck"></span>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-8">
                      <input type="text" class="form-control" name="salary" id="salary" value="<?php echo $infor->salary?>" placeholder="Mức lương">
                      <span name="name_autocheck" class="autocheck"></span>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-8">
                      <textarea  id="editor1" class="form-control"  name="descr_1" value="<?php echo $infor->descr_1?>" placeholder="Mô tả thêm công việc"><?php echo $infor->descr_1?></textarea>
                      <span name="name_autocheck" class="autocheck"></span>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-8">
                      <input type="text" class="form-control" name="languages" id="languages" value="<?php echo $infor->languages?>" placeholder=" Ngôn ngữ">
                      <span name="name_autocheck" class="autocheck"></span>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-8">
                      <textarea id="editor2" class="form-control"  name="descr_2"  value="<?php echo $infor->descr_2?>"><?php echo $infor->descr_2?></textarea>
                      <span name="name_autocheck" class="autocheck"></span>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-8">
                      <textarea id="editor2" class="form-control" name="benefit" value="<?php echo $infor->benefit?>"><?php echo $infor->benefit?></textarea>
                      <span name="name_autocheck" class="autocheck"></span>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-8">
                      <input type="text" class="form-control" name="ctuyen" id="ctuyen" value="<?php echo $infor->ctuyen?>" placeholder="Cách tuyển">
                      <span name="name_autocheck" class="autocheck"></span>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-8">
                      <input type="text" class="form-control" name="manager" id="manager" value="<?php echo $infor->manager?>" placeholder="Người phụ trách">
                      <span name="name_autocheck" class="autocheck"></span>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-8">
                      <input type="text" class="form-control" name="phone" id="phone" value="<?php echo $infor->phone?>" placeholder="Điện thoại">
                      <span name="name_autocheck" class="autocheck"></span>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-8">
                      <input type="email" class="form-control" name="email" id="inputEmail3" value="<?php echo $infor->email?>" placeholder="example@gmail.com">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-8">
                      <input type="text" class="form-control" name="req" id="salary" value="<?php echo $infor->req?>" placeholder=" Yêu cầu gửi hồ sơ">
                      <span name="name_autocheck" class="autocheck"></span>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-8">
                      <input type="text" class="form-control" name="receipt" id="receipt" value="<?php echo $infor->receipt?>" placeholder="Hạn nhận hồ sơ">
                      <span name="name_autocheck" class="autocheck"></span>
